...
import { COMPANY_INFO, WHATSAPP_URL } from '@components/data/companyInfo'
import { HERO_CONTENT, HERO_HEADING_ID } from '@components/data/heroContent'
...
const HeroBadge = () => (
  <p className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-center text-xs font-semibold tracking-wide text-white uppercase backdrop-blur-sm sm:text-sm">
...
const HeroDescription = () => (
  <p className="max-w-2xl text-center text-base leading-relaxed text-white/80 sm:text-lg md:text-xl">
